...
/**
* _forkprocess - create child process
* @av: pointer to array of user of strings
* @buffer: pointer to user
* @fullpathbuffer: pointer
*
* Return: 0 on success
*/
